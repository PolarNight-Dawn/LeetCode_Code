...
public:
    ...
    void BackTracing52(std::vector<std::vector<std::string>> &res, std::vector<int> &row,
        ...
        for (int i = 0; i < n; i++) {
            if (isValid(row, col, bias1, bias2, i, newRow)) {
                ...
                BackTracing52(res, row, col, bias1, bias2, tmp, n, newRow + 1);
    ...
    int totalNQueens(int n) {
        ...
        BackTracing52(res, row, col, bias1, bias2, tmp, n, 0);
